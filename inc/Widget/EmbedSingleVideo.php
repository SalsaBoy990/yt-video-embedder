...
namespace AG\YTVideoEmbedder\Widget;

defined('ABSPATH') or die();

class EmbedSingleVideo extends \WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        require AG_YT_VIDEO_EMBEDDER_PLUGIN_DIR . '/pages/single_video_widget_template.php';
    }
        ...
        <div>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>">
                    <?php _e('Title:', 'ag-yt-video-embedder'); ?>
                </label>
                <input
                    class="widefat"
            ...
            <p>
                <label for="<?php echo $this->get_field_id('url'); ?>">
                    <?php _e('Youtube video link to embed:', 'ag-yt-video-embedder'); ?>
                </label>
                <input
                    class="widefat"
                    id="<?php echo $this->get_field_id('url'); ?>"
                    name="<?php echo $this->get_field_name('url'); ?>"
                    type="url" value="<?php echo $url; ?>" />
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('start_time'); ?>">
                    <?php _e('Start time in seconds:', 'ag-yt-video-embedder'); ?>
                </label>
                <input
                    size="4"
                    class="widefat"
                    id="<?php echo $this->get_field_id('start_time'); ?>"
                    name="<?php echo $this->get_field_name('start_time'); ?>"
                    type="number" min="0" step="1"
                    value="<?php echo $start_time; ?>" />
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('privacy_enhanced'); ?>">
                    <?php _e('Enhanced Privacy mode:', 'ag-yt-video-embedder'); ?>
                </label>
                <input
                    type="checkbox"
                    name="<?php echo $this->get_field_name('privacy_enhanced'); ?>"
                    value="1" <?php checked($privacy_enhanced, 1); ?> />
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('autoplay'); ?>">
                    <?php _e('Autoplay:', 'ag-yt-video-embedder'); ?>
                </label>
                <input
                    type="checkbox"
                    name="<?php echo $this->get_field_name('autoplay'); ?>"
                    value="1" <?php checked($autoplay, 1); ?> />
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('captions'); ?>">
                    <?php _e('Captions:', 'ag-yt-video-embedder'); ?>
                </label>
                <input
                    type="checkbox"
                    name="<?php echo $this->get_field_name('captions'); ?>"
                    value="1" <?php checked($captions, 1); ?> />
            </p>
