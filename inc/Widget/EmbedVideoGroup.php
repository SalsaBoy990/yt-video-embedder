...
class EmbedVideoGroup extends \WP_Widget
{
    // DB TABLE
    ...
    public function widget($args, $instance)
    {
        ...
        require AG_YT_VIDEO_EMBEDDER_PLUGIN_DIR . '/pages/group_video_widget_template.php';
    }
