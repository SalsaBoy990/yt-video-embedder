...
class Shortcodes
{
  ...
  public function single_video_shortcode($atts, $content = null)
  {
    ...
    // view
    require(__DIR__ . '/../views/single_video_shortcode.php');
  ...
  public function group_video_shortcode($atts, $content = null)
  {
    ...
    // view
    require(__DIR__ . '/../views/group_video_shortcode.php');
